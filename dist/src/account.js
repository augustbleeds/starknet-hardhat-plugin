...
class Account {
    ...
    multiInteract(choice, callParameters, options = {}) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const contractInteractOptions = Object.assign(Object.assign({ signature: this.getSignatures(messageHash) }, options), { rawInput: false // rawInput shouldn't affect validating args of __execute__
             });
    ...
    declare(contractFactory, options = {}) {
        return __awaiter(this, void 0, void 0, function* () {
            if (contractFactory.isCairo1()) {
                return yield this.declareV2(contractFactory, options);
            }
    ...
    declareV2(contractFactory, options = {}) {
        return __awaiter(this, void 0, void 0, function* () {
            const maxFee = options === null || options === void 0 ? void 0 : options.maxFee;
            if (!maxFee) {
                const msg = "maxFee must be provided to send declare transactions.\n" +
                    "A value of '0' for 'maxFee' is not supported.";
                throw new starknet_plugin_error_1.StarknetPluginError(msg);
            }
            const version = constants_1.DECLARE_VERSION;
            const nonce = options.nonce == null ? yield this.getNonce() : options.nonce;
            const hre = yield Promise.resolve().then(() => __importStar(require("hardhat")));
            const chainId = hre.starknet.networkConfig.starknetChainId;
            const compiledClassHash = yield hre.starknetWrapper.getCompiledClassHash(contractFactory.casmPath);
            const classHash = yield hre.starknetWrapper.getSierraContractClassHash(contractFactory.metadataPath);
            const calldata = [classHash];
            const messageHash = (0, account_utils_1.calculateDeclareV2TxHash)(this.address, calldata, maxFee.toString(), chainId, [nonce.toString(), compiledClassHash]);
...
class OpenZeppelinAccount extends Account {
    ...
    static getAccountFromAddress(address, privateKey) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const keyPair = starknet_1.ec.getKeyPair(starknet_1.number.toBN(privateKey.substring(2), "hex"));
    ...
    setGuardian(newGuardianPrivateKey, invokeOptions) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (!BigInt(newGuardianPrivateKey || 0)) {
                ...
                guardianKeyPair = starknet_1.ec.getKeyPair(starknet_1.number.toBN(newGuardianPrivateKey.substring(2), "hex"));
                guardianPublicKey = starknet_1.ec.getStarkKey(guardianKeyPair);
            }
            const call = {
